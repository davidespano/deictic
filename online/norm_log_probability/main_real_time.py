from online.norm_log_probability.modelling_gesture import Parse
from online.norm_log_probability.test_models import testRealTime
from online.norm_log_probability.result import DatasetTestResult
# CsvDataset
...
models = CreateRecognizer.createHMMs(expressions = expressions, num_states = 6, spu = 20)
...
outputDir = '/home/ale/PycharmProjects/deictic/online/results/1dollar_dataset/'
...
person = "ale"
#person = "sara"
datasetDir = "/home/"+person+"/PycharmProjects/deictic/repository/deictic/shrec-dataset/resampled/"
