class datasetExpressions:
    ...
    class TypeDataset(Enum):
        dollar1_unistroke = 0
        dollar1_multistroke = 1
        unica = 2
        shrec = 3

    def returnExpressions(self, selected_dataset):
        if selected_dataset == datasetExpressions.TypeOperator.dollar1_unistroke:
            return datasetExpressions.__returnDollar1Unistroke()
        if selected_dataset == datasetExpressions.TypeOperator.dollar1_multistroke:
            return datasetExpressions.__returnDollar1Multistroke()
        if selected_dataset == datasetExpressions.TypeOperator.unica:
            return datasetExpressions.__returnUnica()
        if selected_dataset == datasetExpressions.TypeOperator.shrec:
