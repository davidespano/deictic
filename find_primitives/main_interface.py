...
gesture_datasets = {
    # 'arrow': (4,[CsvDatasetExtended(Config.baseDir+"deictic/1dollar-dataset/raw/arrow/")]), #done
    # 'caret': (2,[CsvDatasetExtended(Config.baseDir+"deictic/1dollar-dataset/raw/caret/")]), #done
    # 'check': (2,[CsvDatasetExtended(Config.baseDir+"deictic/1dollar-dataset/raw/check/")]), #done
